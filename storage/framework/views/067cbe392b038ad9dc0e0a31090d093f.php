...
<body>
    <div class="container">
        ...
        <div class="body">
            <div class="field">
                <label>User ID</label>
                <div class="value"><?php echo e($userId); ?></div>
            </div>
            <div class="field">
                <label>User Email</label>
                <div class="value"><?php echo e($userEmail); ?></div>
            </div>
            <div class="field">
                <label>Error Message</label>
                <div class="value error"><?php echo e($errorMessage); ?></div>
            </div>
            <?php if($url): ?>
            <div class="field">
                <label>Page URL</label>
                <div class="value"><?php echo e($url); ?></div>
            </div>
            <?php endif; ?>
            <?php if($userAgent): ?>
            <div class="field">
                <label>User Agent</label>
                <div class="value"><?php echo e($userAgent); ?></div>
            </div>
            <?php endif; ?>
            <?php if($screenshot): ?>
            <div class="screenshot">
                <div class="field"><label>Screenshot</label></div>
                <img src="<?php echo e($screenshot); ?>" alt="Screenshot">
            </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php /**PATH /Users/shahen1/apps/mebel/backend/resources/views/emails/error-report.blade.php ENDPATH**/ ?>