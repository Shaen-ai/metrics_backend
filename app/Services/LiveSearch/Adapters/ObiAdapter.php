...
class ObiAdapter implements SearchAdapterInterface
{
    public function search(string $query, array $config): Collection
    {
        $baseUrl = $config['base_url'] ?? 'https://www.obi.de';
        ...
        // OBI typically returns HTML with embedded product data
        // Try to find JSON-LD or product data in script tags
